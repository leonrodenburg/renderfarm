...
void Initialize()
{
    ...
    RFGeometry::Cube* pCube2 = new RFGeometry::Cube(1.0f, RFMath::Vector3(-2.0f, -1.5f, 10.0f));
    ...
    RFGeometry::Cube* pCube4 = new RFGeometry::Cube(1.0f, RFMath::Vector3(1.5f, 1.0f, 15.0f));
